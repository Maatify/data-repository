...
class LoggerInjectionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->adapter = new class implements AdapterInterface {
            ...
            /** @return PDO */
            public function getConnection(): mixed { return new PDO('sqlite::memory:'); }
            /** @return PDO */
            public function getDriver(): mixed { return new PDO('sqlite::memory:'); }
    ...
    public function testDefaultConstructorInjectsNullLogger(): void
    {
        $repo = new class($this->adapter) extends BaseRepository {
             ...
             */
            public function findOneBy(array $filters): ?array { return rand(0, 1) ? [] : null; }
            ...
            public function insert(array $data): int|string { return rand(0, 1) ? 1 : '1'; }
