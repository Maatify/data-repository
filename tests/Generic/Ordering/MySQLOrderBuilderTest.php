...
class MySQLOrderBuilderTest extends TestCase
{
    ...
    {
        // '1invalid' starts with a digit. OrderParser cleans it to '1invalid',
        // but MySQLOrderBuilder regex requires start with [a-zA-Z_], so it should be ignored.
        $orderBy = ['valid_col' => 'ASC', '1invalid' => 'DESC'];
