...
{
    private MockObject|GenericMySQLRepository $repository;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->getMockBuilder(GenericMySQLRepository::class)
            ->setConstructorArgs([$this->adapter, 'test_table'])
