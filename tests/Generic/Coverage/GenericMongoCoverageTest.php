...
class GenericMongoCoverageTest extends TestCase
{
    ...
    {
        // Use anonymous class to expose the private/protected logic
    ...
    public function testGetCollectionObjThrowsExceptionIfDriverFails(): void
    {
        ...
        $repo = new class($this->adapter, 'test') extends GenericMongoRepository {
    ...
    public function testInsertThrowsExceptionOnInvalidId(): void
    {
        ...
        $repo = new class($this->adapter, 'test', $collection) extends GenericMongoRepository {
            private object $mockCollection;

            public function __construct(AdapterInterface $adapter, string $table, object $mockCollection)
            {
